...
SELECT film.title, film.description, film.release_year, film.rating, film.special_feature, category.name AS genre
FROM film
...
WHERE film.rating = 'G'
AND film.special_feature
LIKE 'behind the scenes'
WHERE film.actor_id = 15;
...
FROM category
LEFT JOIN category ON category_id = film_category.category_id
